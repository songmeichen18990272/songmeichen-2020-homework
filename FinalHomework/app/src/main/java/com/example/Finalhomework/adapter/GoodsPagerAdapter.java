...
import com.example.Finalhomework.fragment.BookCoverFragment;
import com.example.Finalhomework.fragment.BookDetailFragment;

import java.util.ArrayList;


public class GoodsPagerAdapter extends FragmentStatePagerAdapter {
    private final ArrayList<String> mTitleArray; // 声明一个标题文字队列
